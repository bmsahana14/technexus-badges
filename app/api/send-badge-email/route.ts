          ...
          <html>
            <body style="font-family: sans-serif; background-color: #f0f9ff; padding: 20px;">
              <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 16px; padding: 40px; text-align: center; border: 1px solid #e2e8f0;">
                <h1 style="color: #1a237e; margin-bottom: 8px;">Congratulations!</h1>
                <p style="color: #64748b; font-size: 18px;">You've earned a new badge.</p>
                ...
                <a href="${badgeUrl}" style="display: inline-block; background: #1890ff; color: white; padding: 14px 28px; border-radius: 8px; text-decoration: none; font-weight: bold;">
